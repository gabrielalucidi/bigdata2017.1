...
class SearchEngine
{
    ...
    {
        $cmd = '/home/bigdata/spark-2.1.0-bin-hadoop2.7/bin/spark-submit ../facebook-event-mapper/target/scala-2.10/facebook-event-mapper_2.10-0.2.jar "/opt/lampp/htdocs/bigdata" "' . $this->neighborhood . '" 2>&1';
        $log = shell_exec($cmd);
